void runPicoDstarAnaMaker(TString d0list, TString outFileName, TString badRunListFileName = "picoList_bad_MB.list")
{
  ...
  StPicoDstarAnaMaker*  picoDstarAnaMaker = new StPicoDstarAnaMaker("picoDstarAnaMaker", d0list, outFileName.Data(), picoDstMaker, grefmultCorrUtil);
  picoDstarAnaMaker->fillQaHistograms(false);
  // picoDstarAnaMaker->fillQaHistograms(true);
